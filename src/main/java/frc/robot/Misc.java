...
public class Misc {
    ...
    public static final Pose2d BLUE_REEF_H_POSITION = new Pose2d(5.811,4.378,new Rotation2d(Math.toRadians(180)));
    ...
    public static final Pose2d RED_REEF_H_POSITION = new Pose2d(11.720,3.652,new Rotation2d(Math.toRadians(0)));
